...
| `vendor_cost_dollars` | The underlying cost before margin. `0` when the response required no billable vendor call — for example, a cache hit |
| `pricing_model` | Always `dynamic` for this endpoint (cost-plus-margin) |
