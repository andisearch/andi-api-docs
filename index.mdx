...
All requests require an API key passed in the `x-api-key` header. Get your key from the [API Console](https://console.andiai.com/signup).
...
The same key covers both core endpoints: `/api/v1/search` for web search and [`/api/v1/fetch`](/search/content-retrieval) for reading a page as clean extracted content:
