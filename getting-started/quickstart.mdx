...
Search from your terminal without writing any code — get a key from the [API Console](https://console.andiai.com), then:
...
See the [CLI guide](/getting-started/cli) for fetch, output formats, and the local MCP server.
