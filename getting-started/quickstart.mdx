...
Search from your terminal without writing any code — get a key from the [API Console](https://console.andiai.com/signup), then:

```bash
export ANDI_API_KEY=YOUR_API_KEY
npx -y @andiai/cli search "what is RAG"
npx -y @andiai/cli fetch https://en.wikipedia.org/wiki/Retrieval-augmented_generation
```
