...
Point any agent at the install guide and it will set itself up:

```text
https://api.andiai.com/install.md
```

The guide walks through getting an API key, connecting the MCP server, and verifying the setup. It includes snippets for Claude Code, Cursor, Codex, VS Code, and generic MCP clients.
