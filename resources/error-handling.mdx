...
description: Error response format, status codes, and retry strategies for the Andi Search API.
---
...
| `402` | Insufficient credits | Your account balance is depleted. [Add credits](https://console.andiai.com) to continue. |
| `429` | Rate limit exceeded | Too many requests. Back off and retry after the period in the `Retry-After` header. |
